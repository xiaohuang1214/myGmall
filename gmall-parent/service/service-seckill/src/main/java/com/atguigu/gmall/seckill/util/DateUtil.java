...
public class DateUtil {
    ...
    public static void main(String[] args) {
        for (Date dateMenu : getDateMenus()) {
            String s = data2str(dateMenu, PATTERN_YYYY_MM_DDHHMM);
            String e = data2str(addDateHour(dateMenu, 2), PATTERN_YYYY_MM_DDHHMM);
            System.out.println(s);
            System.out.println(e);
            String s1 = formatStr(s, PATTERN_YYYY_MM_DDHHMM, PATTERN_YYYYMMDDHH);
